...
def main():
    ...
    test_data_02_initial.test_matrD_0 *= 8.

    test_data_02 = cor02.Bmmap502PhPh()
    test_data_02.test_matrD *= 8.
    test_data_02.test_matrD_0 *= 8.

    test_data_04_initial = cor04.Bmmap504PhPh()
    test_data_04_initial.test_matrD *= 8.
    test_data_04_initial.test_matrD_0 *= 8.

    test_data_04 = cor04.Bmmap504PhPh()
    test_data_04.test_matrD *= 8.
    test_data_04.test_matrD_0 *= 8.
    ...
    Ps_alg = {"poisson": [], "cor02": [], "cor04": []}
    P1s = {"poisson": [], "cor02": [], "cor04": []}
    P2s = {"poisson": [], "cor02": [], "cor04": []}
    Ps_imp = {"poisson": [], "cor02": [], "cor04": []}
    ...
    for nextN in tqdm(range(1, 31)):
        ...
        table_poisson.append(
            [Ns[-1], P1s["poisson"][-1], P2s["poisson"][-1], Ps_alg["poisson"][-1], Ps_imp["poisson"][-1]])
        table_cor_02.append([Ns[-1], P1s["cor02"][-1], P2s["cor02"][-1], Ps_alg["cor02"][-1], Ps_imp["cor02"][-1]])
        table_cor_04.append([Ns[-1], P1s["cor04"][-1], P2s["cor04"][-1], Ps_alg["cor04"][-1], Ps_imp["cor04"][-1]])

    plt.plot(Ns, Ls["poisson"], next(linecycler))
    plt.plot(Ns, Ls["cor02"], next(linecycler))
    plt.plot(Ns, Ls["cor04"], next(linecycler))
    plt.ylabel('$L$')
    plt.xlabel('$N$')
    ...
    plt.savefig(str.format("plots/BMMAP5_L_N_cor_0_02_04_{}.png", nowdate),
                dpi=400,
                bbox_inches='tight')
    plt.close()

    # DEPRECATED
    # plt.plot(Ns, Ps["poisson"], next(linecycler))
    # plt.plot(Ns, Ps["cor02"], next(linecycler))
    # plt.plot(Ns, Ps["cor04"], next(linecycler))
    ...
    #
    # plt.savefig(str.format("plots/BMMAP5_P_loss_N_cor_0_02_04_{}.png", nowdate),
    #             bbox_inches='tight')
    # plt.close()

    plt.plot(Ns, Ps_alg["poisson"], next(linecycler))
    plt.plot(Ns, Ps_alg["cor02"], next(linecycler))
    plt.plot(Ns, Ps_alg["cor04"], next(linecycler))
    plt.ylabel(r'$P_{loss}$')
    plt.xlabel(r'$N$')
    plt.legend((r'$c_{cor}^{(1)}$ =' + str(abs(round(qs1.queries_stream.c_cor[0], 3))) + r', $c_{cor}^{(2)}$=' + str(
        abs(round(qs1.queries_stream.c_cor[1], 3))),
               ...
               loc=0)
    if PRINT_TITLE:
        plt.title('Зависимость P_loss_alg от N при различных\n коэффициентах корреляции длин двух соседних интервалов')

    plt.savefig(str.format("plots/BMMAP5_P_loss_alg_N_cor_0_02_04_{}.png", nowdate),
                dpi=400,
                bbox_inches='tight')
    plt.close()

    plt.plot(Ns, P1s["poisson"], next(linecycler))
    plt.plot(Ns, P1s["cor02"], next(linecycler))
    plt.plot(Ns, P1s["cor04"], next(linecycler))
    ...
    plt.legend((r'$c_{cor}^{(1)}$ =' + str(abs(round(qs1.queries_stream.c_cor[0], 3))) + r', $c_{cor}^{(2)}$=' + str(
        abs(round(qs1.queries_stream.c_cor[1], 3))),
               ...
               loc=0)
    if PRINT_TITLE:
        plt.title('Зависимость P1_loss от N при различных\n коэффициентах корреляции длин двух соседних интервалов')

    plt.savefig(str.format("plots/BMMAP5_P1_loss_N_cor_0_02_04_{}.png", nowdate),
                dpi=400,
                bbox_inches='tight')
    plt.close()

    plt.plot(Ns, P2s["poisson"], next(linecycler))
    plt.plot(Ns, P2s["cor02"], next(linecycler))
    plt.plot(Ns, P2s["cor04"], next(linecycler))
    ...
    plt.legend((r'$c_{cor}^{(1)}$ =' + str(abs(round(qs1.queries_stream.c_cor[0], 3))) + r', $c_{cor}^{(2)}$=' + str(
        abs(round(qs1.queries_stream.c_cor[1], 3))),
               ...
               loc=0)
    if PRINT_TITLE:
        plt.title('Зависимость P2_loss от N при различных\n коэффициентах корреляции длин двух соседних интервалов')

    plt.savefig(str.format("plots/BMMAP5_P2_loss_N_cor_0_02_04_{}.png", nowdate),
                dpi=400,
                bbox_inches='tight')
    plt.close()

    plt.plot(Ns, Ps_imp["poisson"], next(linecycler))
    plt.plot(Ns, Ps_imp["cor02"], next(linecycler))
    plt.plot(Ns, Ps_imp["cor04"], next(linecycler))
    ...
    plt.legend((r'$c_{cor}^{(1)}$ =' + str(abs(round(qs1.queries_stream.c_cor[0], 3))) + r', $c_{cor}^{(2)}$=' + str(
        abs(round(qs1.queries_stream.c_cor[1], 3))),
               ...
               loc=0)
    if PRINT_TITLE:
        plt.title('Зависимость P_loss_imp от N при различных\n коэффициентах корреляции длин двух соседних интервалов')

    plt.savefig(str.format("plots/BMMAP5_P_loss_imp_N_cor_0_02_04_{}.png", nowdate),
                dpi=400,
                bbox_inches='tight')
    plt.close()

    plt.plot(Ns, w1s["poisson"], next(linecycler))
    plt.plot(Ns, w1s["cor02"], next(linecycler))
    plt.plot(Ns, w1s["cor04"], next(linecycler))
    ...
    plt.legend((r'$c_{cor}^{(1)}$ =' + str(abs(round(qs1.queries_stream.c_cor[0], 3))) + r', $c_{cor}^{(2)}$=' + str(
        abs(round(qs1.queries_stream.c_cor[1], 3))),
               ...
               loc=0)
    if PRINT_TITLE:
        plt.title('Зависимость w1 от N при различных\n коэффициентах корреляции длин двух соседних интервалов')

    plt.savefig(str.format("plots/BMMAP5_w1_N_cor_{}.png", nowdate),
                dpi=400,
                bbox_inches='tight')
    plt.close()

    plt.plot(Ns, w2s["poisson"], next(linecycler))
    plt.plot(Ns, w2s["cor02"], next(linecycler))
    plt.plot(Ns, w2s["cor04"], next(linecycler))
    ...
    plt.legend((r'$c_{cor}^{(1)}$ =' + str(abs(round(qs1.queries_stream.c_cor[0], 3))) + r', $c_{cor}^{(2)}$=' + str(
        abs(round(qs1.queries_stream.c_cor[1], 3))),
               ...
               loc=0)
    if PRINT_TITLE:
        plt.title('Зависимость w2 от N при различных\n коэффициентах корреляции длин двух соседних интервалов')

    plt.savefig(str.format("plots/BMMAP5_w2_N_cor_{}.png", nowdate),
                dpi=400,
                bbox_inches='tight')
    plt.close()
    ...
    np.savetxt(str.format("tables/BMMAP5_P_losses_N_cor_poisson_{}.csv", nowdate), table_poisson,
               header='N, $P_{loss}^{(1)}$, $P_{loss}^{(2)}$, $P_{loss}, P_{loss}^{(imp)}$', delimiter=',', fmt='%.5f', comments='')
    np.savetxt(str.format("tables/BMMAP5_P_losses_N_cor_02_{}.csv", nowdate), table_cor_02,
               header='N, $P_{loss}^{(1)}$, $P_{loss}^{(2)}$, $P_{loss}, P_{loss}^{(imp)}$', delimiter=',', fmt='%.5f', comments='')
    np.savetxt(str.format("tables/BMMAP5_P_losses_N_cor_04_{}.csv", nowdate), table_cor_04,
               header='N, $P_{loss}^{(1)}$, $P_{loss}^{(2)}$, $P_{loss}, P_{loss}^{(imp)}$', delimiter=',', fmt='%.5f', comments='')
