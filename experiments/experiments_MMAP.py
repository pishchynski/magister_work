...
import debugging.MMAP_Poisson_PH_Poisson_NoRemoval as poisson_noremoval
...
def main():
    ...
    test_data_Poisson_noRemoval_initial = poisson_noremoval.MmapPoissonPhPoissonNoRemoval()
    test_data_Poisson_noRemoval = poisson_noremoval.MmapPoissonPhPoissonNoRemoval()
